            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="hidden" name="formulario" id="formulario" value="creditosventasxfechas_agrupado"/>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-users"></i> Créditos Agrupados por Cliente</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Créditos</li>
                                <li class="breadcrumb-item active" aria-current="page">Agrupados por Cliente</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="creditosventasxfechas_agrupado" id="creditosventasxfechas_agrupado">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group has-feedback">
                <label class="control-label">Estado de Crédito: <span class="symbol required"></span></label>
                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="status" id="1" value="<?php echo encrypt("1"); ?>" checked="checked">
                      <span class="new-control-indicator"></span>GENERAL
                    </label>

                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="status" id="2" value="<?php echo encrypt("2"); ?>">
                      <span class="new-control-indicator"></span>PAGADA
                    </label>
                </div>

                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="status" id="3" value="<?php echo encrypt("3"); ?>">
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarCreditosVentasxFechasAgrupado()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestracreditosxfechas_agrupado"></div>
    ...
    // Función para buscar créditos agrupados por cliente
