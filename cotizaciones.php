...
<body onLoad="muestraReloj(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarCotizaciones()<?php } ?>" class="fix-header">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <input type="hidden" name="formulario" id="formulario" value="cotizaciones"/>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarCotizaciones()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarCotizaciones(){
        ...
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaCotizaciones=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
