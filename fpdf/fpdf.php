...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	$this->StdPageSizes = array(
		...
		'mitad'=>array(311,396), 
		'ticket_8mm'=>array(211,800),
		'ticket_credito_8mm'=>array(211,520),
		'ticket_cierre_8mm'=>array(211,650),
		'ticket_movimiento_8mm'=>array(211,380),
		'ticket_5mm'=>array(131.875,800), 
		'ticket_credito_5mm'=>array(131.875,520),
		'ticket_cierre_5mm'=>array(131.875,650),
		'ticket_movimiento_5mm'=>array(131.875,380)
	);
...
function RowFacturePreimpreso($data)
{
    //Calculate the height of the row
	$nb=0;
	for($i=0;$i<count($data);$i++)
	...
	for($i=0;$i<count($data);$i++)
	{
		...
		$y=$this->GetY();
        //Draw the border
		$this->Rect($x,$y,0,0,0,false);
        //Print the text
		$this->MultiCell($w,7.6,$data[$i],0,$a);
        //Put the position to the right of the cell
		$this->SetXY($x+$w,$y);
	}
    //Go to the next line
