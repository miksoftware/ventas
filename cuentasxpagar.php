...
<body onLoad="muestraReloj(); getTime(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarCuentasxPagar()<?php } ?>" class="fix-header">
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div id="save">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarCuentasxPagar()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarCuentasxPagar(){
    
        $('#muestra_detalles').append('<center><i class="fa fa-spin fa-spinner"></i> Por favor espere, cargando registros ......</center>').fadeIn("slow");
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaCuentasxPagar=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
