            ...
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    <label class="control-label">Existencia: <span class="symbol required"></span></label>
                     <input type="text" class="form-control" name="existencia2" id="existencia2" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Existencia" value="0.00" autocomplete="off" required="" aria-required="true"/>  
                    <i class="fa fa-bolt form-control-feedback"></i>
                </div>
            </div>
...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="updatepedido" id="updatepedido" data-id="<?php echo $reg[0]["codpedido"]; ?>">
    ...
    <form class="form form-material" method="post" action="#" name="agregapedido" id="agregapedido" data-id="<?php echo $reg[0]["codpedido"]; ?>">
...
<?php if (isset($_GET['codpedido']) && isset($_GET['codsucursal']) && decrypt($_GET["proceso"])=="U") { ?>
    ...
    <div id="detallespedidos"><!-- div id update -->
...
<?php } else if (isset($_GET['codpedido']) && isset($_GET['codsucursal']) && decrypt($_GET["proceso"])=="A") { ?>
    ...
    <div id="detallespedidos"><!-- div id agregar -->
