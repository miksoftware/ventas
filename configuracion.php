             ...
             <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="tlfsucursal" id="tlfsucursal" value="<?php echo $reg[0]['tlfsucursal']; ?>" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Teléfono de Empresa" autocomplete="off" required="" aria-required="true"/>  
                ...
                <div class="col-md-3">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                      ...
                      <a href="#" class="btn btn-dark fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times-circle"></i> Remover</a><small><p>Para Subir el Logo Principal debe tener en cuenta:<br> * La Imagen debe ser extension.png<br> * La imagen no debe ser mayor de 1 MB</p></small>                             </div>
                  </div>
              </div>
