...
<body onLoad="muestraReloj(); <?php if($_SESSION['acceso'] != "administradorG"){ ?>CargarCompras()<?php } ?>" class="fix-header">
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscarCompras()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
...
<?php } ?>
    ...
    function CargarCompras(){
        ...
        setTimeout(function() {
        $('#muestra_detalles').load("consultas?CargaCompras=si&tipobusqueda=1&search_criterio=&desde=&hasta=");
        }, 200);
    }    
    </script>
    <?php } ?>
