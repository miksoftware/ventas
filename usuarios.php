    ...
    <div class="modal-dialog modal-xl">
        ...
        <form class="form form-material" method="post" action="#" name="saveuser" id="saveuser" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="telefono" id="telefono" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Teléfono" autocomplete="off" required="" aria-required="true"/>  
            ...
            <div class="row"> 
                ...
                <div class="col-md-3"> 
                    <div class="form-group has-feedback"> 
                       ...
                       <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="comision" id="comision" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Comisión por Ventas" value="0.00" required="" aria-required="true">
                ...
                <div class="col-md-3"> 
                    <div class="form-group has-feedback"> 
                       <label class="control-label">Limite en Descuento %: <span class="symbol required"></span></label> 
                       <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="limite_descuento" id="limite_descuento" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Limite en Descuento %" value="0.00" required="" aria-required="true">
                       <i class="fa fa-usd form-control-feedback"></i>  
                    </div> 
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                document.getElementById('limite_descuento').value = '0.00',
