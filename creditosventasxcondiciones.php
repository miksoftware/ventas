            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="hidden" name="formulario" id="formulario" value="creditosventasxcondiciones"/>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Créditos por Condiciones</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="creditosventasxcondiciones" id="creditosventasxcondiciones">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group has-feedback">
                <label class="control-label">Seleccione Tipo Búqueda: <span class="symbol required"></span></label>
                <i class="fa fa-bars form-control-feedback"></i>
                <select style="color:#000;font-weight:bold;" name="tipobusqueda" id="tipobusqueda" class="form-control" required="" aria-required="true">
                <option value=""> -- SELECCIONE -- </option>
                <option value="<?php echo encrypt("1"); ?>">GENERAL</option>
                <option value="<?php echo encrypt("2"); ?>">PAGADAS</option>
                <option value="<?php echo encrypt("3"); ?>">PENDIENTES</option>
                <option value="<?php echo encrypt("4"); ?>">VENCIDAS</option>
                </select>
            </div>
        </div>
    </div>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarCreditosVentasxCondiciones()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestracreditosxcondiciones"></div>
