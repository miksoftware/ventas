                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Sucursales Asociadas</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Búsqueda de Productos por Sucursal</h4>
            </div>
        ...
        <form class="form form-material" method="post" action="#" name="productosxsucursalasociada" id="productosxsucursalasociada">
            ...
            <div class="row">
                ...
                <div class="text-right">
                    <button type="button" id="BotonBusqueda" onClick="BuscaProductosxSucursalesAsociadas()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                </div>
