   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">              
        ...
        <div class="page-wrapper">
            ...
            <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Detalles por Condiciones</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Ventas</li>
                                <li class="breadcrumb-item active" aria-current="page">Por Condiciones</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Detalles por Condiciones</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="detallesventasxcondiciones" id="detallesventasxcondiciones">
    ...
    <div class="row">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipopago" id="1" value="<?php echo encrypt("1"); ?>" checked="checked">
                      <span class="new-control-indicator"></span>GENERAL
                    </label>

                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipopago" id="2" value="<?php echo encrypt("2"); ?>">
                ...
                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipopago" id="3" value="<?php echo encrypt("3"); ?>">
        ...
        <div class="col-md-3">
            <div class="form-group has-feedback">
                ...
                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipodetalle" id="detalle_0" value="<?php echo encrypt("0"); ?>" checked="checked">
                      <span class="new-control-indicator"></span>GENERAL
                    </label>

                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipodetalle" id="detalle_1" value="<?php echo encrypt("1"); ?>">
                ...
                <div class="n-chk">
                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipodetalle" id="detalle_2" value="<?php echo encrypt("2"); ?>">
                      <span class="new-control-indicator"></span>COMBOS
                    </label>

                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                      <input type="radio" class="new-control-input" name="tipodetalle" id="detalle_3" value="<?php echo encrypt("3"); ?>">
                      <span class="new-control-indicator"></span>SERVICIOS
                    </label>
                </div>
            </div>
        </div>
            ...
            <input type="text" class="form-control" name="hasta" id="hasta" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha Hasta" autocomplete="off" required="" aria-required="true"/>  
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscaDetallesVentasxCondiciones()" class="btn btn-dark"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallesventasxcondiciones"></div>
