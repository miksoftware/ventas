...
<div class="row">
    ...
    $j = new Login();
    $reg = $j->PreventasPorId(); ?>
          
    <form class="form form-material" method="post" action="#" name="updatepreventa" id="updatepreventa" data-id="<?php echo $reg[0]["codpreventa"]; ?>">
    ...
    <form class="form form-material" method="post" action="#" name="agregapreventa" id="agregapreventa" data-id="<?php echo $reg[0]["codpreventa"]; ?>">
            
    <?php } else { ?>
            
    <form class="form form-material" method="post" action="#" name="savepreventa" id="savepreventa">
    ...
    <input type="hidden" name="tipodocumento" id="tipodocumento" <?php if (isset($reg[0]['tipodocumento'])) { ?> value="<?php echo $reg[0]['tipodocumento']; ?>" <?php } else { ?> value="<?php echo $tipodocumento = ($ticket_general == 5 ? "TICKET_PREVENTA_5" : "TICKET_PREVENTA_8"); ?>" <?php } ?>>
...
<?php if (isset($_GET['codpreventa']) && isset($_GET['codsucursal']) && decrypt($_GET["proceso"])=="U") { ?>
    ...
    <div id="detallespreventas"><!-- div id update -->
...
<?php } else if (isset($_GET['codpreventa']) && isset($_GET['codsucursal']) && decrypt($_GET["proceso"])=="A") { ?>
    ...
    <div id="detallespreventas"><!-- div id agregar -->
...
<a href="preventas"><button class="btn btn-dark" type="button"><span class="fa fa-trash-o"></span> Cancelar</button></a> 
