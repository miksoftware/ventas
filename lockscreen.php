              ...
              <div id="loginform">
                ...
                <div class="logo">
                  <span class="db"><?php if (file_exists("fotos/logo_login.png")){
                    echo "<img src='fotos/logo_login.png' width='90%;' height='100px;' alt='Logo Principal'>"; 
                            } else {
                    echo "<img src='' width='90%;' height='100px;' alt='Logo Principal'>"; 
                            } 
                    ?></span>
                      ...
                      <div class="col-xs-12 text-center">
                        <div class="user-thumb text-center"> 
                            <?php if (isset($_SESSION['dni'])) {
                                    ...
                                    echo "<img src='fotos/avatar.jpg' width='100' class='rounded-circle'>"; 
                                    } } else {
                                    echo "<img src='fotos/avatar.jpg' width='100' class='rounded-circle'>"; 
                                    }
                            ?>
