...
$(document).ready(function() {
    ...
    $('#savecompra').keypress(function(e){
    ...
    } else if(prec3=="" || prec3=="0" || prec3=="0.00"){
    ...
    } else if (parseFloat(prec) > parseFloat(prec1) && prec1 != "0.00") {
        ...
        $.each(data, function(i, item) {
            ...
            if (cantsincero != 0) {
                ...
                var nuevaFila =
                    ...
                    "<td><strong>" + Separador(DetalleDescuento.toFixed(2)) + "<sup>" + Separador(item.descproductofact) + "%</sup></strong></td>" +
