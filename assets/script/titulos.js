...
document.title = '.:: Sistema para la Gestión de Ventas e Inventarios Multisucursal ::.';		
$(".current-year").text('2024 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados');
