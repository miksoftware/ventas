...
function DoAction(idproducto, codproducto, producto, descripcion, imei, condicion, codmarca, marcas, codmodelo, modelos, codpresentacion, presentacion, codcolor, color, preciocompra, precioventa, descproducto, posicionimpuesto, tipoimpuesto, ivaproducto, existencia, precioconiva, tipodetalle) {
    addItem(idproducto, codproducto, 1, producto, descripcion, imei, condicion, codmarca, marcas, codmodelo, modelos, codpresentacion, presentacion, codcolor, color, preciocompra, precioventa, descproducto, posicionimpuesto, tipoimpuesto, ivaproducto, existencia, precioconiva, tipodetalle, '+=');
}
        ...
        function(data, textStatus) {
            ...
            $.each(data, function(i, item) {
                ...
                var nuevaFila =
                    ...
                    "<td><strong>" + (item.ivaproducto == "0" ? item.tipoimpuesto : item.tipoimpuesto + ' (' + Separador(item.ivaproducto) + '%)') + "</td>" +
...
function addItem(id, codigo, cantidad, producto, descripcion, imei, condicion, codmarca, marcas, codmodelo, modelos, codpresentacion, presentacion, codcolor, color, precio, precio2, descproducto, posicionimpuesto, tipoimpuesto, ivaproducto, existencia, precioconiva, tipodetalle, opCantidad) {
    var Carrito            = new Object();
    Carrito.Id              = id;
