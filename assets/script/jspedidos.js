    ...
    function AgregaProductos () {        
        ...
        function(data, textStatus) {
            ...
            $.each(data, function(i, item) {
                ...
                "<td><strong>" + Separador(DetalleDescuento.toFixed(2)) + "<sup>" + item.descproductofact + "%</sup></strong></td>" +
...
function addItem(id, codigo, cantidad, producto, descripcion, imei, condicion, codmarca, marcas, codmodelo, modelos, codpresentacion, presentacion, codcolor, color, precio, precio2, precio3, precio4, descproductofact, descproducto, posicionimpuesto, tipoimpuesto, ivaproducto, precioconiva, opCantidad) {
    var Carrito = new Object();
    Carrito.Id               = id;
    ...
    Carrito.Precio1          = precio2;
    Carrito.Precio2          = precio3;
    Carrito.Precio3          = precio4;
