    ...
    <div class="row">
        <div class="col-md-12"> 
            <div class="form-group has-feedback"> 
                ...
                <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" class="form-control" onChange="CargaCajas(this.form.codsucursal.value);CargaFormasPagosxSucursal(this.form.codsucursal.value);" required="" aria-required="true">
