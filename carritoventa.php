...
if ($ObjetoCarrito->Codigo=="vaciar") {
    ...
    if (isset($_SESSION['CarritoVenta'])) {
        ...
        if (isset($ObjetoCarrito->Codigo)) {
            ...
            $opcionimei       = $ObjetoCarrito->OpcionImei;
            ...
            for($i=0;$i<=count($carrito)-1;$i ++){
                ...
                //if($tipodetalle == $carrito[$i]['tipodetalle'] && $id == $carrito[$i]['id'] && $txtCodigo == $carrito[$i]['txtCodigo'] && $producto == $carrito[$i]['producto'] && $precio2 == $carrito[$i]['precio2']){
